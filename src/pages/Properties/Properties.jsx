      ...
      <div className='row w-100 bg-white' style={{ marginTop: 150, zIndex: -100 }}>
        <div style={{ height: '50vh' }} className="mx-2 row">
          {houseloading
            ...
            : houses && houses.map((house) => <div key={house.id} className="col-sm" ><PropertyItem house={house} key={house.id} /></div>)}
          <div className="ml-4">
            {params.page > 0
                && (
                <>
                  ...
                  <button type="button" className="bg-primary text-white p-1" onClick={handlePageClickPrev}>Prev</button>
                </>
             )}
            ...
            {params.page < numPages - 1
                && (
                <>
                  <button type="button" className="bg-primary text-white p-1" onClick={handlePageClickNext}>Next</button>
                  <span className="text-primary p-2 mx-2">...</span>
