...
function ContactForm({ ownerId, houseId, phone }) {
  ...
  return (
    <div className="contact-form p-4">
      <form onSubmit={handleSend}>
        ...
        />
        <FormInput
          handleChange={(e) => setSenderPhone(e.target.value)}
          data={senderPhone}
          name="senderPhone"
          type="text"
          label="Your phone*"
        ...
        />
        <FormInput
          handleChange={(e) => setSenderEmail(e.target.value)}
          data={senderEmail}
          name="senderEmail"
          type="text"
          label="Your Email*"
      ...
      <strong>or</strong>
      <WhatsApp phone={phone} text="Chat on WhatsApp" />
    </div>
  );
}
